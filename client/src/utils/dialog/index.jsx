...
export const Dialog = ({isOpen, isLoading, serial, name, surname, onCancel, onDelete, isError}) => {
    ...
    return (
        <div className="main-dialog-container" key={serial}>
            ...
            <div className="dialog-buttons-container">
                ...
                <Loader isLoading={isLoading} color={theme.colors.white} bgColor={theme.colors.warning}>
                    <Button variant={'warning'} size={'regular'} onClick={() => onDelete(serial)}>Delete</Button>
                </Loader>
            </div>
        </div>
    )
